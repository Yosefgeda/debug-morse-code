...
# 📖 [debug-morse-code] <a name="about-project"></a>

**[debug-morse-code]** A program to decode and print a morse code to a human readable form.
...
```sh
  cd my-folder
  git clone https://github.com/yosefgeda/decode-morse-code.git
```
...
Feel free to check the [issues page](https://github.com/yosefgeda/decode-morse-code/issues).
